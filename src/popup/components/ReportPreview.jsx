  ...
  return (
    <div className="bg-white rounded-lg border border-slate-200 p-3.5 space-y-2.5">
      ...
      <textarea
        ...
        rows={14}
        className="w-full px-2.5 py-2 rounded border border-slate-200 bg-slate-50 text-slate-700 text-[12px] leading-relaxed font-mono resize-y focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent"
      />
      <button
        onClick={handleCopy}
